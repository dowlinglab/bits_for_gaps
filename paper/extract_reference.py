...
fig5 = {
    ...
    "source": "gp_predict_{train,test}_{iter} vs activity_data_1[:,2] / activity_test_points[:,2]",
...
write_json(
    "mccabe_thiele_stages.json",
    {
        ...
        "stages": [
            {
                "stage": 1,
                "wilson": {"liquid": 0.22, "vapor": 0.43},
                "surrogate": {"liquid": 0.25, "vapor": 0.43},
            },
            {
                "stage": 2,
                "wilson": {"liquid": 0.05, "vapor": 0.32},
                "surrogate": {"liquid": 0.05, "vapor": 0.34},
            },
            {
                "stage": 3,
                "wilson": {"liquid": 0.03, "vapor": 0.24},
                "surrogate": {"liquid": 0.03, "vapor": 0.24},
            },
            {
                "stage": 4,
                "wilson": {"liquid": 0.02, "vapor": 0.14},
